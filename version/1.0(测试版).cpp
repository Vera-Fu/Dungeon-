...
void runGame() {
    ...
    printf("新人か？めずらしいね...\n\n");
    msleep(2000);
    printf("新人はギルガメッシュから無料なキャラを二つ与えられる...\n\n");
    msleep(3000);
    printf("GOOD LUCK...");
    msleep(2000);
    clrscr();
    ...
    G_checkMapNum = 1;
    player[0] = { 5, 9, 1, 0, 30 };
    boss[0] = {"Dungeonの守護者·ギルガメッシュ·ルイーダ", 1000, 1000, 100, 50, 10, 10, 20, 1};
...
void mapsPaint2() {
    ...
    gotoxy(35, 10);
    map[10] = { wherex(), wherey() - 1, 0, 0, 0, 0, 1, 1 };
}
...
void mapsPaint3() {
    ...
    map[7] = { wherex(), wherey() - 1, 0, 0, 1, 0, 1, 1 };
    gotoxy(35, 5);
    map[8] = { wherex(), wherey() - 1, 0, 0, 0, 1, 1, 1 };
    gotoxy(25, 5);
    map[9] = { wherex(), wherey() - 1, 0, 0, 0, 0, 1, 1 };
    gotoxy(15, 5);
